...
/*   Updated: 2021/08/02 14:33:46 by ybrutout         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/push_swap.h"

static int	mdpnt_check(t_num *col, int median, int len, int sign)
{
	t_num	*tmp;
...
static int	mdpnt_first_bis(t_col **index, int median, int pivot)
{
...
static int	mdpnt_bis(t_col **index, int len, int median)
{
	t_num	*tmp;
	int		last_a;
