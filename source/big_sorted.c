...
/*   Updated: 2021/08/02 14:30:20 by ybrutout         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/push_swap.h"

static void	init_indx(t_col **index, int **lst_sort)
{
	int		i;
	int		j;
	t_num	*tmp;
...
static char	*itoa_base_remix(int nb, int size)
{
	char	*c;
...
static int	init_binary(t_col **index, int **lst_sort)
{
	t_num	*tmp;
	t_num	*col;
	int		i;
